...
**Prompt（提示词）** 是你发送给大语言模型的输入文本，用于引导模型生成你期望的输出。
...
# ✅ 提供足够信息
"请用 Python 实现一个读取 CSV 文件并计算每列平均值的脚本"
```
...
```python
# ❌ 一次塞太多要求
"写一个完整的电商系统，包括用户管理、商品管理、订单管理、支付系统、物流追踪..."

# ✅ 分解任务
"请先帮我设计电商系统的用户管理模块的数据库表结构"
```
...
# ✅ 明确指代
"请将以下 Python 函数改成异步实现，使用 async/await 语法：
[你的代码]"
```
